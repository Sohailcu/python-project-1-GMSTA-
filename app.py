...
# st.sidebar.write("Select a section below:")  

# page = st.sidebar.radio("Go to", ["Quiz", "Chatbot", "File Converter", "To-Do List"])  
...
#     st.switch_page("pages/3_File_Converter.py")  
# elif page == "To-Do List":  
#     st.switch_page("pages/4_Todo_List.py")  